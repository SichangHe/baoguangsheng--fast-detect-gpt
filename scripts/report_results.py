...
def report_main_results(args):
    datasets = {"xsum": "XSum", "squad": "SQuAD", "writing": "WritingPrompts"}
    source_models = {
        "gpt2-xl": "GPT-2",
        "opt-2.7b": "OPT-2.7",
...
def report_refmodel_results(args):
    datasets = {"xsum": "XSum", "squad": "SQuAD", "writing": "WritingPrompts"}
    source_models = {"gpt2-xl": "GPT-2", "gpt-neo-2.7B": "Neo-2.7", "gpt-j-6B": "GPT-J"}
...
def report_chatgpt_gpt4_results(args):
    datasets = {"xsum": "XSum", "writing": "Writing", "pubmed": "PubMed"}
    source_models = {"gpt-3.5-turbo": "ChatGPT", "gpt-4": "GPT-4"}
    score_models = {
        "t5-11b": "T5-11B",
        "gpt2-xl": "GPT-2",
        "opt-2.7b": "OPT-2.7",
    ...
    filters2 = {
        "likelihood": [".gpt2-xl", ".gpt-neo-2.7B", ".gpt-j-6B", ".gpt-neox-20b"],
...
def report_maxlen_trends(args):
    datasets = {"xsum": "XSum", "writing": "WritingPrompts"}
    source_models = {"gpt-3.5-turbo": "ChatGPT", "gpt-4": "GPT-4"}
    score_models = {
        "t5-11b": "T5-11B",
        "gpt2-xl": "GPT-2",
